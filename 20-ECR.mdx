...
**Elastic** -> Highly scalable, flexible, available and cost-effective.
...
1. Log in to your ECR registry using the AWS CLI:
...
3. Tag the image with your ECR repository URI: why? because we need to push the image to the ECR repository.
