...
An **Elastic IP (EIP)** is a **static (fixed) public IPv4 address** provided by Amazon Web Services that you can assign to an Amazon EC2 instance.

#### Simple explanation

Normally, when you stop and start an **EC2 instance**:
